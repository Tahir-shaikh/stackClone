    ...
    <div className='widget'>
        ...
        <div className='right-sidebar-div-1'>
            <div className='right-sidebar-div-2'>
                ...
                <p>Observability is to the future of software (and your DevOps career)</p>
            </div>
            <div className='right-sidebar-div-2'>
                <img src={pen} alt="pen" width='18' />
        ...
        <div className='right-sidebar-div-1'>
            ...
            <div className='right-sidebar-div-2'>
                <p>20</p>
                <p>What is the best course of action when a user has high enough rep yo....</p>
            </div>
            <div className='right-sidebar-div-2'>
                <p>14</p>
                <p>Is a link to the "How yo ask" help page a useful comment?</p>
            </div>
        </div>
